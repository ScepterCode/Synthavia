...
// All three languages now say the same thing: leaving PCM and IG on the pre-Enterprise sentence
// would have told a Pidgin or Igbo reader something the English reader is no longer told.
// 'AI' is left untranslated in both, as it is in ordinary speech. 'Enterprise' stays as-is in
// Pidgin, where the English word is what is actually used, and becomes 'Azụmahịa' — commerce — in
// Igbo. These remain drafts: a second pair of eyes decides, not this file.

const phrases = {
  EN: { 'nav.enterprise': 'Enterprise', 'nav.about': 'About', 'nav.core': 'Core', 'nav.lab': 'Lab', 'nav.programs': 'Programs', 'nav.events': 'Events', 'nav.blog': 'Blog', 'nav.partners': 'Partners', 'nav.contact': 'Contact', 'cta.join': 'Join Core', 'hero.eyebrow': 'ABIA, NIGERIA · EST. 2025', 'hero.title': 'Building Africa\'s <em>AI future</em><br />from Abia.', 'hero.lede': 'We build AI for businesses and institutions, and we train the people who will build the next of it. Both, from Aba.', 'hero.enterprise': 'Explore Enterprise AI', 'hero.explore': 'Explore the ecosystem', 'hero.research': 'See the research', 'hero.note': 'Nnoo. Welcome. Make we build am together.' },
  PCM: { 'nav.enterprise': 'Enterprise', 'nav.about': 'About Us', 'nav.core': 'Core', 'nav.lab': 'Lab', 'nav.programs': 'Programs', 'nav.events': 'Events', 'nav.blog': 'Blog', 'nav.partners': 'Partners', 'nav.contact': 'Talk to Us', 'cta.join': 'Join Core', 'hero.eyebrow': 'ABIA, NAIJA · SINCE 2025', 'hero.title': 'We dey build Africa <em>AI future</em><br />from Abia.', 'hero.lede': 'We dey build AI for businesses and institutions, and we dey train the people wey go build the next one. Both of them, from Aba.', 'hero.enterprise': 'Look Enterprise AI', 'hero.explore': 'Look the ecosystem', 'hero.research': 'See the research', 'hero.note': 'Nnoo. Welcome. Make we build am together.' },
  IG: { 'nav.enterprise': 'Azụmahịa', 'nav.about': 'Banyere Anyị', 'nav.core': 'Core', 'nav.lab': 'Ụlọ Nnyocha', 'nav.programs': 'Mmemme', 'nav.events': 'Ihe Omume', 'nav.blog': 'Blog', 'nav.partners': 'Ndị Mmekọ', 'nav.contact': 'Kpọtụrụ Anyị', 'cta.join': 'Sonye na Core', 'hero.eyebrow': 'ABIA, NAỊJIRIA · EST. 2025', 'hero.title': 'Na-ewu <em>ọdịnihu AI</em> Afrika<br />site na Abia.', 'hero.lede': 'Anyị na-ewu AI maka azụmahịa na ụlọ ọrụ, ma na-azụ ndị ga-ewu nke ọzọ. Ha abụọ, site na Aba.', 'hero.enterprise': 'Chọgharịa Enterprise AI', 'hero.explore': 'Chọgharịa ekosistemu', 'hero.research': 'Hụ nnyocha ahụ', 'hero.note': 'Nnoo. Welcome. Ka anyị wuo ya ọnụ.' }
};
let language = 'EN';
