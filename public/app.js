...
// nav.enterprise and hero.enterprise deliberately carry the English string in PCM and IG: a machine
// guess would be published as though a speaker had written it. Their hero.lede is also still the
// pre-Enterprise sentence — true, but no longer the positioning EN carries. Both wait for the review.
...
const phrases = {
  ...
  PCM: { 'nav.enterprise': 'Enterprise', 'nav.about': 'About Us', 'nav.core': 'Core', 'nav.lab': 'Lab', 'nav.programs': 'Programs', 'nav.events': 'Events', 'nav.blog': 'Blog', 'nav.partners': 'Partners', 'nav.contact': 'Talk to Us', 'cta.join': 'Join Core', 'hero.eyebrow': 'ABIA, NAIJA · SINCE 2025', 'hero.title': 'We dey build Africa <em>AI future</em><br />from Abia.', 'hero.lede': 'We dey train the people, do the research, and ship AI wey go work for how we dey live here.', 'hero.enterprise': 'Explore Enterprise AI', 'hero.explore': 'Look the ecosystem', 'hero.research': 'See the research', 'hero.note': 'Nnoo. Welcome. Make we build am together.' },
  IG: { 'nav.enterprise': 'Enterprise', 'nav.about': 'Banyere Anyị', 'nav.core': 'Core', 'nav.lab': 'Ụlọ Nnyocha', 'nav.programs': 'Mmemme', 'nav.events': 'Ihe Omume', 'nav.blog': 'Blog', 'nav.partners': 'Ndị Mmekọ', 'nav.contact': 'Kpọtụrụ Anyị', 'cta.join': 'Sonye na Core', 'hero.eyebrow': 'ABIA, NAỊJIRIA · EST. 2025', 'hero.title': 'Na-ewu <em>ọdịnihu AI</em> Afrika<br />site na Abia.', 'hero.lede': 'Anyị na-azụ ndị mmadụ, na-eme nnyocha, ma na-ewu AI nke na-arụ ọrụ maka ndụ ndị Afrika.', 'hero.enterprise': 'Explore Enterprise AI', 'hero.explore': 'Chọgharịa ekosistemu', 'hero.research': 'Hụ nnyocha ahụ', 'hero.note': 'Nnoo. Welcome. Ka anyị wuo ya ọnụ.' }
};
let language = 'EN';
